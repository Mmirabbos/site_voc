...
async function middleware(request) {
    const supabaseUrl = ("TURBOPACK compile-time value", "https://ligfpohdlxothpvqdkdd.supabase.co");
    const supabaseKey = ("TURBOPACK compile-time value", "sb_publishable_UxsoH49LrRmkXLPnveAUeQ_iH7V9LMs");
...
const config = {
    matcher: [
        "/((?!_next/static|_next/image|favicon.ico|voc|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)"
    ]
};
}),
]);

...
function Dashboard() {
    ...
    const stats = {
        ...
        // Изучаемые: повторений > 0, но интервал меньше 15 дней
        learning: words.filter((w)=>w.repetitions > 0 && w.interval < 15).length,
        // На повторении: (дублирует learning в нашей логике, можно использовать для тех, что просрочены)
        review: dueWords.length,
        // Выученные: интервал больше 14 дней
...
_s(Dashboard, "Mu167fZV09gQJYb/MGJ1eCN/kX8=", false, function() {
    return [
...
//# sourceMappingURL=_a58dc51e._.js.map